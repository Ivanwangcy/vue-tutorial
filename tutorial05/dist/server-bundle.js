...
/* harmony export (immutable) */ exports["d"] = watchList;
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_vuex_router_sync__["sync"])(__WEBPACK_IMPORTED_MODULE_2__store___default.a, __WEBPACK_IMPORTED_MODULE_3__router__["a" /* default */]);
...
/* harmony reexport (default from non-hamory) */ __webpack_require__.d(exports, "b", function() { return __WEBPACK_IMPORTED_MODULE_2__store___default.a; });
...
var store = new __WEBPACK_IMPORTED_MODULE_1_vuex___default.a.Store({
  ...
  actions: {
    // ensure data for renderer given list type
...
/* harmony export (immutable) */ exports["a"] = createListView;
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
if (__vue_options__.functional) {console.error("[vue-loader] ItemView.vue: functional components are not supported and should be defined in plain js files using render functions.")}
